...
const ContactForm = () => {
  ...
  if (isSubmitted) {
    return (
      <motion.div
        ...
        className="bg-background rounded-lg p-8 shadow-elegant border border-border text-center"
      >
  ...
  return (
    <motion.form
      ...
      className="bg-background rounded-lg p-6 md:p-8 shadow-elegant border border-border space-y-5"
    >
